...
function Barter() {
  ...
  useEffect(() => {
    fetch(
      `https://my-backend-2l7i.onrender.com/api/v1/product/${queryParams.get(
        "id"
      )}`,
      {
        method: "GET",
  ...
  return (
    <div className={styles.barter}>
      {!loading && !loading2 && (
        <div className={styles.barter__container}>
          <div className={styles.barter__container__inner}>
            ...
            <div className={styles.exchange__container}>
              ...
              <img
                src="src\pages\Barter\xchg.svg"
                alt=""
                className={styles.exchange__icon}
              />
            </div>
            <div className={styles.bartered__product}>
              <h1 className={styles.bartered__text}>Your Product</h1>
              {myProducts && (
                <ProductCard product={myProducts[selctedProduct]} />
              )}
              ...
              <input
                ...
                placeholder="Quantity"
                value={qty2}
                onChange={handleQtyChange2}
                min={1}
                max={myProducts[selctedProduct]?.quantity}
              />
            </div>
          </div>
