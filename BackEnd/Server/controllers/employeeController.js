...
exports.addTech = catchAsync(async (req, res, next) => {
  ...
  const { FName, LName, PhoneNumber, Email, Password, Gender, start_working_date } = req.body;
  if (!FName || !LName || !PhoneNumber || !Email || !Password || !Gender || !start_working_date) {
  ...
  const newEmployee = await db.query(`INSERT INTO employee Values(DEFAULT, '${FName}', '${LName}', '${start_working_date}', 'Tech Support',
